...
<tr>
 ...
 <th>
 <!--
 <?php echo $this->lang->line('valid_for_days');?>
 -->
 Type
 </th>
...
<tr>
 ...
 -->
  <input type="text"      value="<?php echo $val['price'];?>" onBlur="updategroupprice(this.value,'<?php echo $val['gid'];?>');" >
  <!--
  <?php echo $this->config->item('base_currency_sufix');?> 
  --> </td>
...
<td>
 ...
 <input type="text"   class="form-control"   name="valid_for_days" value="" placeholder="0"  required ></td>
<td>
